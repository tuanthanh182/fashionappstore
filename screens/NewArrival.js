...
export default function NewArrivalScreen({ navigation }) {
    return (
        <SafeAreaView style={{
            flex: 1,
                    ...
                    <View>
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                ...
                                >
                                    <Image
                                        source={require('../assets/img/shirtwomen5.jpg')}
                                        style={styler.imageItemArrival}
                                    />
                                    <View style={styler.containerItemArrival}>
                                        <Text style={styler.titleItemArrival}>Đầm Body Nữ Dáng Dài</Text>
                                        <Text style={styler.priceItemArrival}>
                                            $ 400.000
                                        </Text>
                                        <Text style={styler.rateItemArrival}>
                                            {staricon} 4.6   320 sold
                                        </Text>
                                    </View>
                                </TouchableOpacity>
                            )}
                    ...
                    <View>
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <TouchableOpacity style={styler.itemArrival}>
                                    <Image
                                        source={require('../assets/img/shirtwomen6.jpg')}
                                        style={styler.imageItemArrival}
                                    />
                                    <View style={styler.containerItemArrival}>
                                        <Text style={styler.titleItemArrival}>Áo Trễ Vai Phối Bèo</Text>
                                        <View style={{
                                            flexDirection: 'row',
                                        }}>
                                            <Text style={{
...
const styler = StyleSheet.create({
    ...
    itemArrival: {
        marginTop: 12, marginRight: 32, paddingBottom: 10,
