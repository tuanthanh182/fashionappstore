...
function HomeScreen({ navigation }) {
    ...
    return (
        <SafeAreaView style={{
            flex: 1,
            marginTop: 30, paddingHorizontal: 18,
        }}>
            <View style={{
            ...
            <ScrollView>
                ...
                >
                    ...
                    <ImageBackground
                        source={require('../assets/img/pic5.jpg')}
                        style={{
                ...
                >
                    ...
                    <ImageBackground
                        source={require('../assets/img/pic6.jpg')}
                        style={{
                            resizeMode: "contain", width: '100%', height: '100%',
                        }}
                    >
                ...
                >
                    ...
                    <ImageBackground
                        source={require('../assets/img/pic7.jpg')}
                        style={{
                            resizeMode: "contain", width: '100%', height: '100%',
                        }}
                    >
