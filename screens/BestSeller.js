                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <TouchableOpacity style={[styler.itemArrival, { height: 256, }]}>
                                    ...
                                    />
                                    <View style={styler.containerItemArrival}>
                                        <Text style={styler.titleItemArrival}>Đầm Dài Tay Dáng Ôm</Text>
                                        <Text style={styler.priceItemArrival}>
                                            $ 149.000
                                        </Text>
                                        <Text style={styler.rateItemArrival}>
                                            {staricon} 4.7   220 sold
                                        </Text>
                                    </View>
                                </TouchableOpacity>
                            )}
                    ...
                    <View>
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                ...
                                >
                                    <Image
                                        source={require('../assets/img/shirtwomen4.jpg')}
                                        style={styler.imageItemArrival}
                                    />
                                    <View style={styler.containerItemArrival}>
                                        <Text style={styler.titleItemArrival}>Chân váy đuôi cá HUIZUMEI</Text>
                                        <View style={{
                                            flexDirection: 'row',
                                        }}>
                                            <Text style={{
